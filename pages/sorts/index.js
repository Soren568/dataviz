    ...
    return (
        <div className="w-full h-full">
            <div className="flex w-3/4 mx-auto mt-5 mb-1 items-center">
                ...
                <button onClick={() => setUserReset(prev => !prev)} className="px-4 py-1 bg-blue-500 text-xs tracking-widest uppercase text-gray-300 hover:bg-blue-600 rounded-lg transition-all ease-in-out">New Array</button>
